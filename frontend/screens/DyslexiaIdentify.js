...
const DyslexiaPrediction = () => {
  ...
  const uploadImage = async () => {
    ...
    formData.append('file', {
      ...
      name: 'uploaded_image.jpg', // Ensure the file name has the correct extension
    });
    ...
    try {
      ...
      setPredictionResult(response.data.percentages);
    } catch (error) {
      ...
      {predictionResult && (
        <Card style={styles.resultCard}>
          ...
          <Text style={styles.resultText}>
            Corrected: {predictionResult.Corrected.toFixed(2)}%
          </Text>
          <Text style={styles.resultText}>
